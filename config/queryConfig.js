module.exports = {
    ...
    ,
    insertCompleteItem: ''+
    'INSERT INTO TBL_COMPLETE_ITEM(' +
        'DOC_NO,ITEM_NAME,ITEM_QUANTITY,ITEM_UNIT_PRICE,ITEM_AMOUNT' +
    ') VALUES ('+
        '@docNo,@itemName,@itemQuantity,@itemUnitPrice,@itemAmount' +
    ')'
    ,
    insertCompleteHistory: ''+
    'INSERT INTO TBL_COMPLETE_HISTORY(' +
        'DOC_NO,ORIGIN_TEXT,COMPLETE_TEXT' +
    ') VALUES ('+
        '@docNo,@origintext,@completeText' +
    ')'
}